// Header MAAD - Updated December 28, 2023
function noop() { }
const identity = x => x;
...
function create_each_block_3(ctx) {
	...
	return {
		...
		h() {
			attr(a, "class", "nav-item svelte-fgegha");
...
function create_each_block_2(ctx) {
	...
	return {
		...
		h() {
			attr(a, "class", "button svelte-fgegha");
			attr(a, "href", a_href_value = /*link*/ ctx[8].url);
		},
		m(target, anchor) {
			insert_hydration(target, a, anchor);
...
function create_if_block(ctx) {
	...
	return {
		...
		h() {
			attr(hr, "class", "svelte-fgegha");
			attr(button, "id", "close");
			attr(button, "aria-label", "Close Navigation");
			attr(button, "class", "svelte-fgegha");
			attr(nav, "id", "mobile-nav");
			attr(nav, "class", "svelte-fgegha");
		},
		m(target, anchor) {
...
function create_fragment(ctx) {
	...
	return {
		...
		h() {
			attr(a, "href", "/");
			attr(a, "class", "logo svelte-fgegha");
			set_style(a, "--size", style___size);
			attr(button, "id", "open");
			attr(button, "aria-label", "Open mobile navigation");
			attr(button, "class", "svelte-fgegha");
			attr(nav, "class", "svelte-fgegha");
			attr(div0, "class", "desktop-nav svelte-fgegha");
			attr(div1, "class", "section-container svelte-fgegha");
			attr(header, "class", "svelte-fgegha");
		},
		m(target, anchor) {
