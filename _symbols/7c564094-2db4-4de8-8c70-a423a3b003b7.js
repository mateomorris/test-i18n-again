...
function create_fragment(ctx) {
	...
	return {
		...
		l(nodes) {
			...
			t1 = claim_text(h1_nodes, /*headline*/ ctx[0]);
			h1_nodes.forEach(detach);
			t2 = claim_space(div1_nodes);
			h2 = claim_element(div1_nodes, "H2", { class: true });
			var h2_nodes = children(h2);
			t3 = claim_text(h2_nodes, /*subheading*/ ctx[2]);
		...
		h() {
			attr(div0, "class", "section-container svelte-kaxk0i");
			attr(h1, "class", "headline svelte-kaxk0i");
			attr(h2, "class", "subheading svelte-kaxk0i");
			attr(div1, "class", "section-container svelte-kaxk0i");
			set_style(header, "background-image", "url('" + /*background*/ ctx[1].url + "')");
			attr(header, "role", "img");
			attr(header, "aria-label", header_aria_label_value = /*background*/ ctx[1].alt);
			attr(header, "class", "svelte-kaxk0i");
		},
		m(target, anchor) {
		...
		p(ctx, [dirty]) {
			if (dirty & /*headline*/ 1) set_data(t1, /*headline*/ ctx[0]);
			...
			if (dirty & /*background*/ 2 && header_aria_label_value !== (header_aria_label_value = /*background*/ ctx[1].alt)) {
...
function instance($$self, $$props, $$invalidate) {
	...
	return [headline, background, subheading, props];
}
