...
function create_each_block_1(ctx) {
	...
	return {
		...
		h() {
			attr(a, "class", "link svelte-1p2u7ie");
...
function create_fragment(ctx) {
	...
	return {
		c() {
			...
			t0 = space();
			span = element("span");
			t1 = text("© MAAD Metal s.p. 2023, all rights reserved");
			t2 = space();
			div = element("div");
		...
		l(nodes) {
			...
			t1 = claim_text(span_nodes, "© MAAD Metal s.p. 2023, all rights reserved");
		...
		h() {
			attr(nav_1, "class", "svelte-1p2u7ie");
			attr(span, "class", "sredinski_napis svelte-1p2u7ie");
			attr(div, "class", "social-links svelte-1p2u7ie");
			attr(footer, "class", "section-container svelte-1p2u7ie");
		},
		m(target, anchor) {
